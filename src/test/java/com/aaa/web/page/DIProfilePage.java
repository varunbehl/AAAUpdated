...
public class DIProfilePage {
    ...
    public static By lnkBeyondETAUnderAddMenuIcon;
    public static By drpdwnHiddenTabs;
    public static By lnkBeyondETAUnderHiddenTab;
    public static By lnkBeyondETAUnderProfileTab;
    public static By statusOnBeyonETA;
    public static By callOutIcon;
    public static By lblOLStatus;
    public static By statusAllCallsTab;
    public static By rightClickOnCall;
    public static By contextMenuItems;
    public static By upDownArrowPopTheProfile;
    public static By lnkTextOverrideWithOnContextMenu;
    public static By btnStsArrow;
    public static By btnDateArrow;
    public static By btnIDArrow;
    public static By txtCommentsToTextArea;
    public static By btnSaveForAddComments;
    public static By lblEtaWindowName;
    public static By lblStsColumnHeaderInProfileWindow;
    public static By txtETAHoursOnUpdateETAwindow;
    public static By txtETAMinsOnUpdateETAwindow;
    public static By btnContinueOnETAUpdateWindow;
    public static By lstTruckLoadOnProfileWindow;
    public static By lblTruckIDOnProfileWindow;
    ...
    static {
        ...
        lnkBeyondETAUnderAddMenuIcon=By.xpath("//*[@class='add-tab-list d3ui-menu d3ui-menu-constrained']//*[text()='Beyond ETA']");
        ...
        lnkBeyondETAUnderProfileTab=By.xpath("//*[contains(@id,'profile-window-')]//*[contains(text(),'Beyond ETA')]");
        lblOLStatus=By.xpath("//div[contains(@title,'OL - On Location')][contains(text(),'OL')]");
        upDownArrowPopTheProfile = By.xpath("//a[@class='d3ui-panel-btn popout-profile-btn']");
        lnkTextOverrideWithOnContextMenu=By.xpath("//*[contains(text(),'With Override Time')]");
        btnStsArrow=By.cssSelector("ul[class='selected selectable-list ui-sortable'] li:nth-child(1) button");
        btnDateArrow=By.cssSelector("ul[class='selected selectable-list ui-sortable'] li:nth-child(2) button");
        btnIDArrow=By.cssSelector("ul[class='selected selectable-list ui-sortable'] li:nth-child(3) button");
        txtCommentsToTextArea=By.xpath("//div[contains(@id,'profile-window')]/textarea[contains(@class,'comment-dialog-content')]");
        btnSaveForAddComments=By.xpath("//span[contains(@id,'ui-dialog-title-profile-window')]/../..//span[contains(text(),'Save')]");
        lblEtaWindowName=By.id("ui-dialog-title-generic-dialog");
        txtETAHoursOnUpdateETAwindow=By.xpath("//div[@id='generic-dialog']//input[@class='eta-other-hrs fixed-content-span25']");
        txtETAMinsOnUpdateETAwindow=By.xpath("//div[@id='generic-dialog']//input[@class='eta-other-mns fixed-content-span25']");
        btnContinueOnETAUpdateWindow=By.xpath("//div/div[@id='generic-dialog']/..//span[contains(text(),'Continue')]");
        //lblTruckIDOnProfileWindow=By.xpath("(//div[@id='ALLOW_AS-20180416-20000']/div[@class='context-menu-item'])[1]");
        lblStsColumnHeaderInProfileWindow = By.xpath("//div[contains(@id,'tab-table')]//div[@id='profile_callstatus']");
    }
    ...
    public static By statusOnPfofile(String callId){
        String xpath = "//div[contains(@id,'tab-call-list')]/..//div[contains(@id,'profile_3-"+callId+"')]/div[2]"; //*[contains(@id,'profile_3-20180124-20063')]
    ...
    public static By getStatusForCallIdOnProfileBeyondETA(String callId, String callIdDate)throws  Throwable{
        String xpath = "//*[contains(@id,'"+callIdDate+"-"+callId+")]/div[2]/div[contains(@class,'profile-call-status-')]";
        statusOnBeyonETA=By.xpath(xpath);
        return statusOnBeyonETA;
    }

    public static By callOutIconOnProfileWIndow(String callId, String callIdDate){
        String xpath = "//*[contains(@id,'"+callIdDate+"-"+callId+"')]//div[@title='Auto-Callout in Progress']";
        callOutIcon=By.xpath(xpath);
        return callOutIcon;
    }

    public static By getStatusForCallIdOnAllCallsTab(String callId, String callIdDate)throws  Throwable{
        String xpath = "//*[contains(@id,'profile_3-"+callIdDate+"-"+callId+"')]/div[2]/div[2]";
        statusAllCallsTab=By.xpath(xpath);
        return statusAllCallsTab;
    }
    public static By mouseHoverToContextMenu(String callId,String callStatus){
        String xpath = "//*[@id='callMenu-"+callId+"']//span[contains(text(),'"+callStatus+"')]";
        lblcomments=By.xpath(xpath);
        return lblcomments;
    }
    public static By selectFromContextMenu(String title)
    {
        String xpath = "//div[@title='"+title+"']";
        rightClickOnCall = By.xpath(xpath);
        return rightClickOnCall;
    }
    public static By clickOnETATime(String time)throws  Throwable{
        String xpath = "//div[@id='ALLOW_ETA']//div[@title='"+time+"']";
        contextMenuItems=By.id(xpath);
        return contextMenuItems;
    }
    public static By selectFromContextMenu(String callIDAndDate,String title)throws  Throwable{
        String xpath = "//*[@id='callMenu-"+callIDAndDate+"']//span[contains(text(),'"+title+"')]";
        lblcomments=By.xpath(xpath);
        return lblcomments;
    }
    public static By getCallIDStatusFromAllCallsTab(String callId, String callIdDate)throws  Throwable{
        String xpath = "//*[contains(@id,'profile_3-"+callIdDate+"-"+callId+"')]//div[@class='profile-call-status-descr']";
        statusAllCallsTab=By.xpath(xpath);
        return statusAllCallsTab;
    }
    public static By getTruckList(String callIdAndDate)throws  Throwable{
        String xpath = "//div[@id='ALLOW_AS-"+callIdAndDate+"']/div[@class='context-menu-item']";
        lstTruckLoadOnProfileWindow=By.xpath(xpath);
        return lstTruckLoadOnProfileWindow;
    }
    public static By selectTruck(String callIdAndDate)throws  Throwable{
        String xpath = "(//div[@id='ALLOW_AS-"+callIdAndDate+"']/div[@class='context-menu-item'])[1]";
        lblTruckIDOnProfileWindow=By.xpath(xpath);
        return lblTruckIDOnProfileWindow;
    }
}
