...
public class CRLocationsPage {
    ...
    public static By txtFirstCrossstreet;
    public static By txtSecondCrossstreet;
    ...
    public static By homeDestIcon;
    public static By ddnFirstItemSelection;
    public static By RecentDestIcon;
    public static By viewOptionsinPickupPoint;
    public static By pickupPointMenu;
    public static By txtLocCity_required;
    public static By txtLocState_required;
    public static By txtLocCode_required;
    public static By txtStreetAddress_required;
    ...
    static {
        ...
        txtStreetAddress_required = By.cssSelector("input[id='bl-street-input1'][class='d3ui-field d3ui-fielditem loc-street-field d3ui-show d3ui-required']");
        txtStreetAddress = By.cssSelector("input[id='bl-street-input1']");
        txtLocCity_required = By.cssSelector("input[id='bl-city-input1'][class='d3ui-field loc-city-field ui-autocomplete-input ui-corner-left d3ui-show d3ui-required']");
        txtLocCity = By.cssSelector("input[id='bl-city-input1']");
        txtLocState = By.id("bl-state-input1");
        txtLocState_required=By.cssSelector("input[id='bl-state-input1'][class='d3ui-field loc-state-field ui-autocomplete-input ui-corner-left d3ui-show d3ui-required']");
        txtLocCode_required = By.cssSelector("input[id='bl-location-code-input1'][class='d3ui-field loc-location-code-field ui-autocomplete-input ui-corner-left d3ui-show d3ui-required']");
        ...
        txtFirstCrossstreet=By.id("bl-cross-street-input1");
        txtSecondCrossstreet=By.id("bl-second-cross-street-input1");
        ...
        homeDestIcon = By.xpath("//*[@id='loc-known-addresses-container-breakdown-workflow']//..//*[@class='d3ui-icon d3ui-icon-homesplat']");
        RecentDestIcon = By.xpath("//*[@id='loc-known-addresses-container-breakdown-workflow']//..//*[@class='d3ui-icon d3ui-icon-callsplat']");
        viewOptionsinPickupPoint = By.xpath("//*[@id='bl-pickup-point-input1']//..//*[contains(@title, 'View Options')]");
        pickupPointMenu = By.xpath("(//ul[@class='ui-autocomplete ui-menu ui-widget ui-widget-content ui-corner-all'][last()])[3]/li");
    }

    public static By ddnFirstItemSelection(String Name) {
        //String xpath = "//div[@id='triage-group-tabs']//span[contains(text(),'"+problemtype+"')]";
        String xpath = "//a[text()='"+Name+"']";
        ddnFirstItemSelection = By.xpath(xpath);
        return ddnFirstItemSelection;
    }
