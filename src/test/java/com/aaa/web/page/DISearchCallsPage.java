...
public class DISearchCallsPage {
	...
	public static By lnkFourthCallID;
	...
	static {
		...
		btnSearchAgain=By.xpath("//button[@id='call-search-back-btn']/span[contains(text(),'Search Again')]");
		...
		lnkSecondcallId=By.xpath("(//a[@class='row-selection action-row-callback'])[3]");
		lnkFourthCallID=By.xpath("(//a[@class='row-selection action-row-callback'])[4]");
	}
