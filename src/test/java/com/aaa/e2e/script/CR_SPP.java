...
public class CR_SPP extends LoginLib
{
    ...
    @Test()
    public void CRSPPEnd2End(int StartRow,String EndRow,boolean nextTestJoin) throws Throwable {
        try
        {
            int intStartRow=StartRow;
            int intEndRow=ReportControl.fnGetEndRowCunt(EndRow, "CRSPP", TestData, "e2eCRSPP");
            for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
            {
                try {
                    ...
                    Hashtable<String, String> data=TestUtil.getDataByRowNo("CRSPP", TestData, "e2eCRSPP",intCounter);
                    TestEngineWeb.reporter.initTestCaseDescription("CR SPP End to End"+ " From Iteration " + StartRow + " to " + EndRow );
                ...
                ReportStatus.fnUpdateResultStatus("CR_SPP","7777",ReportStatus.strMethodName,intCounter,browser);
    ...
    public void diCallClearProcess(Hashtable<String, String> data) throws Throwable
    {
        if (data.get( "CompleteCall").equalsIgnoreCase("save")) {
            ...
            boolean reasonCodeTextBoxAvailability= dimcdLib.resolutionCode(data.get("ResolutionCode"),data.get("Reason"),data.get("BatteryInfo"),data.get("ResolutionCode"),data.get("StatusUpdateCL"));

            //Checking for Resaon dropdown is enabled or disabled
            if(reasonCodeTextBoxAvailability==true){
               ...
               //Checking credit card error message
