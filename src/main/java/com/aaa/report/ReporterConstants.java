...
public interface ReporterConstants {
	...
	String EM_BASE_URL = ConfigFileReadWrite.read(ReporterConstants.configReporterFile, "emBaseUrl");
	String NC_BASE_URL = ConfigFileReadWrite.read(ReporterConstants.configReporterFile, "ncBaseUrl");
