...
public class DBUtils {
	...
	public static void executeSqlStmt(DB db, String sqlStmt, Object... params) throws SQLException {
		...
		try {
			...
			System.out.println("executeSqlStmt"+sqlStmt);
			/**
...
//			}
	...
	public static void select(DB db, String sqlStmt, DBResultSetProcessor processor, Object... params) {
		Connection dbConnection = null;
		PreparedStatement preparedStatement = null;
		try {
			dbConnection = getConnection(db);
...
//				}
	...
	public static ArrayList<LinkedHashMap<String, Object>> selectValuesFromDB(DB db, String sqlStmt, Object... params) {
		Connection dbConnection = null;
		PreparedStatement preparedStatement = null;
