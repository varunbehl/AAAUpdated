...
public class RSPHomePage {
    ...
    public static By drpdwnSelectSearchType=By.xpath("//button[contains(@title,'archived orders')]/preceding-sibling::div/div[@class='inline-select']//select");
    public static By lnkMultiSelectSearchType=By.xpath("//button[contains(@title,'archived orders')]/preceding-sibling::div/div//button");
    public static By lstValuesMultiSelectSearchType=By.xpath("//*[@id='multiselect-dashboard-multiselect']//li");
    ...
    public static By lblManageShops=By.xpath("//a[@label='Manage Shops']");
    ...
    public static By lblClubSettings=By.xpath("//a[@label='Club Settings']");
    
    //Dashboard View
  
    public static By lblDashboard=By.xpath("//*[@class='navbar-brand']");
    public static By tabDashBoard=By.xpath("//span[@title='Dashboard']");

    //dynamic method for find a call in Rsp using call id
