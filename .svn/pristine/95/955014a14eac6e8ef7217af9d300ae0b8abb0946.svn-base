...
public class TC_SPPMCDClosestTrucks extends LoginLib {
     ...
     * Method Name :-verifySPPMCDClosestTrucks
     * Module	   :- DI
     * Test Case ID:-1926
    ...
    @Test()
    public void verifySPPMCDClosestTrucks(int StartRow,String EndRow,boolean nextTestJoin) throws Throwable {
        try
        {

            int intStartRow=StartRow;
            int intEndRow= ReportControl.fnGetEndRowCunt(EndRow, "verifySPPMCDClosestTrucks", TestData, "D3Dispatch");
            for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
            {
                try {
                    ...
                    Hashtable<String, String> data=TestUtil.getDataByRowNo("verifySPPMCDClosestTrucks", TestData, "D3Dispatch",intCounter);

                    this.reporter.initTestCaseDescription("1926: TC-SPP MCD Closest trucks"+ " From Iteration " + StartRow + " to " + EndRow );
    ...
    @Parameters({"StartRow","EndRow","nextTestJoin"})
    @Test()
    public void verifySPPMCDClosestTrucksPoppedOut(int StartRow,String EndRow,boolean nextTestJoin) throws Throwable {
        try
        {
            ...
            for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
            {
                try {
                    ...
                    this.reporter.initTestCaseDescription("1926 :verifySPPMCDClosestTrucks"+ " From Iteration " + StartRow + " to " + EndRow );
                    reporter.SuccessReport("Iteration Number : ","**************Iteration Number::  "+ intCounter+"   **************");
                    DIFacilityDetailInformationLib diFacilityInfo = new DIFacilityDetailInformationLib();
