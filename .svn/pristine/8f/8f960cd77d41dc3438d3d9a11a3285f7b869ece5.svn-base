...
public class TC_DIProfileBeyondPTATab extends LoginLib {
            ...
            for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
            {
                try {
                    ...
                    if(!reCall.equalsIgnoreCase(null))
                    {
                        ...
                        reporter.failureReport("<b>reCall:</b>","Unable to proceed because call ID is null");
                    }
                    diHome.logOut();
                    acceptAlert();
                    acceptAlert();
                    ...
                    {
                        reporter.failureReport("<b>spCall:</b>","Unable to proceed because call ID is null");
                    }
                    diHome.logOut();
                    acceptAlert();
                    acceptAlert();
                    ...
                    {
                        reporter.failureReport("<b>bdCall:</b>","Unable to proceed because call ID is null");
                    }
                    diHome.logOut();
                    acceptAlert();
                    acceptAlert();
            ...
            for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
            {
                try {
                   ...
                   if(!reCall.equalsIgnoreCase(null))
                   {
                       ...
                       //wait for 6 mints of PTA as per the test step
                       Thread.sleep(360000);
    ...
    public void loginToDIAndClickOnProfile(Hashtable<String, String> data) throws Throwable {
        ...
        diHome.clickOnCloseOnFacilityPTA();
