...
public class TC_CRD3ProportionalSpotGrid extends DILoginLib {
    ...
    public void CRD3ProportionalSpotGrid(int StartRow,String EndRow,boolean nextTestJoin) throws Throwable {
    	try
    	{
    		int intStartRow=StartRow;
    		int intEndRow=ReportControl.fnGetEndRowCunt(EndRow, "CRD3ProportionalSpotGrid", TestData, "D3CallRecieving");
    		for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
    		{
    			try {
					...
					Hashtable<String, String> data = TestUtil.getDataByRowNo("CRD3ProportionalSpotGrid", TestData, "D3CallRecieving", intCounter);

					this.reporter.initTestCaseDescription("1710: TS-CR D3 Proportional Spot Grid" + " From Iteration " + StartRow + " to " + EndRow);
    			...
    			ReportStatus.fnUpdateResultStatus("DI","1710",ReportStatus.strMethodName,intCounter,browser);
    			fnCloseTest();
    		}
    	}
    	catch (Exception e) 
