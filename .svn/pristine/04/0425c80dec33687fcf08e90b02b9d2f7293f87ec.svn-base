            ...
            for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
            {
                try {
                  ...
                  diHome.enterCallIDInfo(newCallId);
                    ...
                    diMCD.clickOnInactive();
                    diMCD.clickOnSearchButton();
                    ...
                    diMCD.clickOnViewSearchCriteria();
                    diMCD.clickOnLoaded();
                    diMCD.clickOnFromOtherFacilities();
                    diMCD.clickOnSearchButton();
                  ...
                  /* step 8 :  Click the view Search Criteria Link and perform the following:
                    ...
                    diMCD.clickOnViewSearchCriteria();
                    diMCD.clickOnFromOtherFacilities();
                    diMCD.clickOnShowBatteryTruckOnly();
                    diMCD.clickOnSearchButton();
                    ...
                    diMCD.clickOnViewSearchCriteria();
                    diMCD.clickOnCrossButtonInTruckTypes();
                    diMCD.clickOnSearchButton();
                    ...
                    diMCD.clickOnAssaignTruckOnList();
                    assertTrue(diMCD.getCallStatusOnMCDwindow().contains("AS"), "Call status stayed in AS");
