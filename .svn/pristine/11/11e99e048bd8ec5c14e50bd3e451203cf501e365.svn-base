	...
	@Parameters({"StartRow","EndRow","nextTestJoin"})
	 @Test()
		...
		try
    	{
    		...
    		int intEndRow=ReportControl.fnGetEndRowCunt(EndRow, "launchViaPartnerRedirectAndVerifyMembership", TestData, "RSOWeb");
    		for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
    		{
    			try {
    					...
    					Hashtable<String, String> data=TestUtil.getDataByRowNo("launchViaPartnerRedirectAndVerifyMembership", TestData, "RSOWeb",intCounter);
    			...
    			ReportStatus.fnUpdateResultStatus("RSO","1681",ReportStatus.strMethodName,intCounter,browser);
    			fnCloseTest();
    		}
    	}
    	catch (Exception e) 
